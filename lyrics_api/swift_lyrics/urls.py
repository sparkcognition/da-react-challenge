...
urlpatterns = [
    ...
    url(r'^lyric/upvote/(?P<pk>\d+)/?$', views.UpvoteLyricDetail.as_view(), name='upvote_lyric'),
    url(r'^lyric/downvote/(?P<pk>\d+)/?$', views.DownvoteLyricDetail.as_view(), name='downvote_lyric'),
